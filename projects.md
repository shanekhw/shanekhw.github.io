...
SAW is a platform that uses a single actuator (a flap) and its only driving force is gravity. This puts SAW in the same category as other platforms relying on gravitatio
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU5MTIwODM5MywtNDkzNzM2NDM3LC0xNT
